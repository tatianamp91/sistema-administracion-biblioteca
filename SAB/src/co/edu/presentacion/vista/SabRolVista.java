...
public class SabRolVista  {
    ...
    public String action_save() {
        try {
            DelegadoNegocioVista.saveSabRol(FacesUtils.checkString(
                    txtDescripcion));
            FacesUtils.addInfoMessage(FacesUtils.getMensaje("rol.guardado"));
            action_clear();
        } catch (Exception e) {
    ...
    public String action_delete() {
        try {
            ...
            FacesUtils.addInfoMessage(FacesUtils.getMensaje("rol.eliminado"));
            action_clear();
        } catch (Exception e) {
            FacesUtils.addErrorMessage(e.getMessage());
        }
    ...
    public String action_modify() {
        try {
            ...
            FacesUtils.addInfoMessage(FacesUtils.getMensaje("rol.modificado"));
            action_clear();
        } catch (Exception e) {
            FacesUtils.addErrorMessage(e.getMessage());
        }
