...
public class SabEditorialLogica {
    public List<SabEditorial> getSabEditorial() throws Exception {
        ...
        try {
            list = XMLHibernateDaoFactory.getInstance().getSabEditorialDAO()
                                         .findAll();
        } catch (Exception e) {
    ...
    public void saveSabEditorial(Long estado, String nombre)
        throws Exception {
        ...
        try {
            ...
            XMLHibernateDaoFactory.getInstance().getSabEditorialDAO()
                                  .save(entity);
    ...
    public void deleteSabEditorial(Long idEditorial) throws Exception {
        ...
        if (idEditorial == null) {
            throw new ZMessManager().new EmptyFieldException("idEditorial");
        }
        ...
        if (entity == null) {
            throw new ZMessManager().new EmptyFieldException("SabEditorial");
        }

        try {
            sabLibros = XMLHibernateDaoFactory.getInstance().getSabLibroDAO()
                                              .findByProperty("sabEditorial.idEditorial",
                    idEditorial);
    ...
    public SabEditorial getSabEditorial(Long idEditorial)
        ...
        try {
            entity = XMLHibernateDaoFactory.getInstance().getSabEditorialDAO()
                                           .findById(idEditorial);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("SabEditorial");
        } finally {
        }
    ...
    public List<SabEditorial> findPageSabEditorial(String sortColumnName,
        ...
        throws Exception {
        List<SabEditorial> entity = null;

        try {
            entity = XMLHibernateDaoFactory.getInstance().getSabEditorialDAO()
                                           .findPageSabEditorial(sortColumnName,
    ...
    public Long findTotalNumberSabEditorial() throws Exception {
        Long entity = null;

        try {
            entity = XMLHibernateDaoFactory.getInstance().getSabEditorialDAO()
                                           .findTotalNumberSabEditorial();
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("SabEditorial Count");
        } finally {
        }
            ...
            * ejempolo: a > 1 and a < 5 --> 1 seria value y 5 seria value2
                ...
                * ejemplo: a comparator1 1 and a < 5
                    ...
                    * ejemplo: a comparador1>1  and a comparador2<5  (el original: a > 1 and a <
                            ...
                            * @throws Exception
                            */
    public List<SabEditorial> findByCriteria(Object[] variables,
